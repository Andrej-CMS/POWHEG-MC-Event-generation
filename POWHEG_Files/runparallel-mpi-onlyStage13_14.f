...
c     stage 1, iteration 3

      call runcommand(trim(main),rank,1,3)
      call mpi_barrier(mpi_comm_world,ierr)

c     stage 1, iteration 4

      call runcommand(trim(main),rank,1,4)
      call mpi_barrier(mpi_comm_world,ierr)

C c     stage 1, iteration 5

C       call runcommand(trim(main),rank,1,5)
C       call mpi_barrier(mpi_comm_world,ierr)
